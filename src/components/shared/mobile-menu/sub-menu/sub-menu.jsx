    ...
    <LazyMotion features={domAnimation}>
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <Button
              className="absolute -top-16 left-7 h-16 w-28 flex items-center !justify-start gap-x-1 !normal-case text-xl font-normal bg-black sm:top-[-60px] sm:h-[60px] sm:left-4 sm:text-[15px]"
              type="button"
