...
const PlayButton = ({ player, size = 'large' }) => (
  <button
    type="button"
    className={clsx(
      'group relative flex flex-shrink-0 items-center justify-center rounded-full border-none bg-white outline-none',
      {
  ...
  >
    ...
    {player.playing ? (
      <svg
        viewBox="0 0 22 28"
        className={clsx(
          'fill-black group-active:fill-gray-8',
          {
            large: 'h-7 w-7',
            medium: 'h-5 w-5',
            small: 'h-4 w-4',
