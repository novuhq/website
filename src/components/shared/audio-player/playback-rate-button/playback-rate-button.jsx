...
const PlaybackRateButton = ({ player }) => {
  const [playbackRate, setPlaybackRate] = useState(playbackRates[0]);

  return (
    <button
      type="button"
      className="hover:bg-slate-100 focus:ring-slate-400 relative flex h-6 w-6 items-center justify-center rounded-md text-gray-8 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2"
      onClick={() => {
