...
const Banner = () => (
  <Link className="relative z-20 block overflow-hidden bg-gray-3 py-2.5" to="/blog/seed-funding">
    <div className="container relative flex items-center justify-center">
      <p className="banner-text">
        We are thrilled to announce our <span>$6.6m</span> seed funding
        <ArrowIcon className="ml-2.5 inline-block h-2.5 w-5" arria-hidden />
      </p>
