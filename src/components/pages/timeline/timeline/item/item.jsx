...
const Item = ({ date, title, description, iconName, animationDelay, isActive, zIndex }) => {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <m.div
        className={clsx(
          'timeline-item group absolute left-[12px] h-fit w-max select-none before:absolute before:bottom-full before:left-[22px] before:h-[800px] before:w-px before:border-l before:border-dashed before:opacity-[0.15]',
          {
