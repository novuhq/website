...
const ITEMS = [
  ...
  },
  {
    ...
    description:
      'Build a demo app of your choice using Novu to serve as a template ',
    url: '/',
  },
  {
    icon: blogIcon,
    ...
    description:
      'Made a PR? Have used Novu in a recent project? Tell the world about it in form of an blog post, articale or guide ',
    url: '/',
  },
  {
    icon: tutorialIcon,
