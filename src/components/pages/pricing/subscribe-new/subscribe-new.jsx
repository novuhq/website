...
const SubscribeNew = ({ className, title, description }) => (
  <section
    className={clsx(
      'subscribe-form safe-paddings relative mb-[250px] mt-[177px] lg:mt-[192px] md:mb-[258px] md:mt-[234px] sm:mb-[194px] sm:mt-[152px]',
      className
    )}
  >
    <div className="container-sm relative md:px-8 sm:w-full sm:px-5">
      <div className="relative z-10 flex flex-col items-center">
        <Heading
          className="max-w-4xl text-center font-medium leading-denser tracking-snug md:text-[40px] sm:text-[32px]"
          size="44"
          tag="h2"
        >
          {title}
        ...
        <p
          className="mt-3 max-w-[464px] text-center text-lg font-book tracking-snug text-gray-8 lg:max-w-[497px] sm:text-base"
