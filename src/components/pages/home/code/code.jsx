  ...
  return (
    <section className="code mt-[206px] lg:mt-36 md:mt-[116px] sm:mt-20">
      <div className="container-lg px-8 min-h-[836px] relative lg:w-full sm:px-5 lg:max-w-5xl lg:min-h-[692px] md:max-w-3xl md:min-h-[535px] sm:min-h-[324px]">
        ...
        <div className="relative z-10 lg:mx-auto sm:max-w-[572px] sm:mx-auto sm-xs:max-w-80">
          <SyntaxHighlighter
            className="echo-code relative z-10 pl-[42px] mt-[70px] scrollbar-hidden text-sm font-normal lg:mt-[62px] lg:pl-[35px] lg:text-xs md:mt-[53px] md:pl-[26px] sm:text-[10px] sm:mt-11 sm:overflow-y-scroll sm:ml-2 sm:pl-[7px] sm:mr-1.5 sm:[mask-image:linear-gradient(270deg,transparent_1%,#FFFFFF_25%)]"
            style={{
              marginTop: '20px',
            }}
            language="javascript"
