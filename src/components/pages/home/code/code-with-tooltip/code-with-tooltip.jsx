...
const TOOLTIP_CONTENT = {
  workflowTooltip: (
    <span className="flex flex-col py-3.5">
      <span className="flex flex-col px-3.5">
...
const CodeWithTooltip = ({ tooltipId, children, tooltipPosition }) => (
  <span className="group relative rounded-sm border border-white/35 bg-white/10" id={tooltipId}>
    ...
    <span
      ...
      } invisible z-20 rounded-lg border border-[rgba(58,64,81,1)] bg-[linear-gradient(159.72deg,rgba(16,26,37,1)_9.88%,rgba(16,20,37,1)_87.56%)] opacity-0 [transition:visibility_0s_0.6s,opacity_0.3s_0.3s_linear] group-hover:visible group-hover:opacity-100 group-hover:[transition:visibility_0s_0s,opacity_0.3s_0s_linear] md:hidden`}
    >
