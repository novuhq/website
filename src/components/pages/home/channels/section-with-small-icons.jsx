...
const SectionWithSmallIcons = ({ title, items }) => (
  <section className="section-with-small-icons safe-paddings mt-40 lg:mt-[120px] md:mt-[100px] sm:mt-20">
    <div className="container-md px-8 sm:w-full sm:px-5">
      ...
      <p className="mt-5 text-center text-[15px] font-light leading-snug tracking-snug text-gray-8 md:text-sm">
      ...
      <p className="mt-14 text-center text-[15px] font-light leading-snug tracking-snug text-gray-8 md:text-sm">
