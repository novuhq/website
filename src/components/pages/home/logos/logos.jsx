...
const Logos = () => (
  <section className="logos safe-paddings bg-black py-20 lg:py-16 sm:py-12">
    <div className="container">
      <h3 className="text-md text-center font-light text-white">{TITLE}</h3>
      <ul className="mt-8 flex w-full justify-between lg:space-x-11 md:flex-wrap md:justify-center md:gap-y-9 md:gap-x-11 md:space-x-0">
