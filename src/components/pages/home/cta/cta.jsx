...
const LINK = {
  text: 'Book Session',
  url: 'https://novu.co/contact-us/?utm_campaign=website-homeCTA',
};
...
const Cta = () => {
  ...
  return (
    <section className="cta mb-[118px] mt-[244px] lg:mb-[104px] lg:mt-[204px] md:mb-[100px] md:mt-[124px] sm:mt-20">
      <div className="container-sm relative">
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="mt-12 flex justify-center gap-x-8 md:mt-7 sm:flex-col sm:items-center">
            ...
            <Button
              className="-mt-px h-14 min-w-[160px] text-sm lg:h-12 sm:mt-[18px] sm:h-auto sm:max-w-none sm:border-none sm:text-[13px] sm:text-primary-1 sm:underline sm:underline-offset-[6px] sm:hover:bg-transparent"
              theme="gray-outline"
              to={LINK.url}
