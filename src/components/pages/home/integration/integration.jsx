...
const Integration = () => (
  <section className="relative integration mt-[120px] lg:mt-[100px] md:mt-20 z-20">
    <div className="container-md">
      ...
      />
      <ul className="grid grid-cols-3 grid-rows-2 mt-12 ml-9 max-w-[928px] gap-y-12 gap-x-8 lg:mt-[44px] lg:gap-x-[26px] lg:ml-0 lg:max-w-none lg:px-9 md:px-0 md:mt-9 md:gap-x-7 md:gap-y-8 md:grid-cols-2 sm:grid-cols-1 sm:gap-y-[27px] sm:mt-8">
