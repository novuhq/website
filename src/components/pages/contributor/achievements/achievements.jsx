...
const Achievements = ({
  ...
  const {
    ...
    query {
      rockStar: file(
        relativePath: { eq: "contributors/achievements/rock-star.png" }
      ) {
        childImageSharp {
      ...
      contributorOfTheYear: file(
        relativePath: {
          eq: "contributors/achievements/contributor-of-the-year.png"
        }
      ) {
        childImageSharp {
          gatsbyImageData(width: 160)
      ...
      contributorOfTheMonth: file(
        relativePath: {
          eq: "contributors/achievements/contributor-of-the-month.png"
        }
      ) {
        childImageSharp {
          gatsbyImageData(width: 160)
      ...
      reporterStar: file(
        relativePath: { eq: "contributors/achievements/reporter-star.png" }
      ) {
        childImageSharp {
          gatsbyImageData(width: 160)
        }
      ...
      teamPlayer: file(
        relativePath: { eq: "contributors/achievements/team-player.png" }
      ) {
        childImageSharp {
          gatsbyImageData(width: 160)
        }
      ...
      goldMedal: file(
        relativePath: { eq: "contributors/achievements/gold-medal.png" }
      ) {
        childImageSharp {
      ...
      silverMedal: file(
        relativePath: { eq: "contributors/achievements/silver-medal.png" }
      ) {
        childImageSharp {
          gatsbyImageData(width: 134)
        }
      ...
      bronzeMedal: file(
        relativePath: { eq: "contributors/achievements/bronze-medal.png" }
      ) {
        childImageSharp {
          gatsbyImageData(width: 134)
        }
  ...
  return (
    <section className="achievements md:mt-20 sm:mt-16">
      <Heading
        className="leading-denser md:text-[30px]"
        tag="h2"
        size="md"
        theme="white"
      >
      ...
      <div className="mt-10 grid grid-cols-4 gap-x-8 gap-y-10 md:gap-x-7 sm:grid-cols-2 sm:gap-x-5">
        {additionalAchievements &&
          additionalAchievements.map(
            ({ achievementDate, achievement }, index) => {
              const {
                title,
      ...
      <div className="mt-9 flex space-x-10">
        ...
        <Share
          type={SHARE_TYPES.embed}
          imageUrl={images.embedImage}
          url={url}
        />
      </div>
    </section>
