...
const TITLE = 'Notification infrastructure for modern teams';
const DESCRIPTION =
...
const CARDS = [
  {
    ...
    description: 'Define workflows as code, re-use components, and deploy confidently while developing in your IDE of choice.',
    className:
  ...
  },
  {
    ...
    description:
      'Rapidly identify and solve previously complicated content hydration and notification routing issues.',
