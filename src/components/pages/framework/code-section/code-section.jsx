...
const CodeSection = ({
  ...
  >
    ...
    >
      <div
        className={clsx(
          'relative w-full max-w-[672px] rounded-[20px] bg-[#05050B] bg-code-underlay-border p-px lg:max-w-[532px] md:mt-12 md:w-full md:max-w-[672px] sm:max-w-[520px]',
          codeClassName
        )}
      >
