...
const Hero = ({ title, description, features, formPosition, hubspotFormId }) => {
  ...
  return (
    <section className="safe-paddings relative pb-16 pt-[202px] lg:py-36 md:pb-10 md:pt-28 sm:pt-22">
      <div className="container-lg relative grid grid-cols-12 gap-x-8 xl:px-0 lg:px-10 md:flex md:flex-col md:px-7 sm:px-4">
        ...
        >
          ...
          <p className="mt-4 text-lg leading-snug text-white text-opacity-70 md:text-base">
            {description}
          </p>
          {features.length > 0 && (
            <ul className="mt-12 flex flex-col gap-y-8 pl-6 md:gap-y-2.5 md:pl-8">
