...
const COMPLIANCE_CARDS_COLORED = [
  {
    title: 'SOC2 Type II',
    image: soc2Icon,
  },
...
const COMPLIANCE_SECTION_COLORED = {
  title: 'ComplianceSection',
  theme: 'colored',
  items: COMPLIANCE_CARDS_COLORED,
};

const COMPLIANCE_SECTION_WHITE = {
  title: 'ComplianceSection',
  theme: 'white',
  items: COMPLIANCE_CARDS_WHITE,
};

const COMPLIANCE_SECTION_COLORED_SMALL = {
  title: 'ComplianceSection',
  theme: 'colored',
  columns: 3,
  items: COMPLIANCE_CARDS_COLORED.slice(0, 3),
};

const COMPLIANCE_SECTION_WHITE_SMALL = {
  title: 'ComplianceSection',
  theme: 'white',
  columns: 3,
  items: COMPLIANCE_CARDS_WHITE.slice(0, 3),
};

export default {
  featureCards: FEATURE_CARDS,
  featureCards2Columns: FEATURE_CARDS_2_COLUMNS,
  ...
  complianceSectionColored: COMPLIANCE_SECTION_COLORED,
  complianceSectionWhite: COMPLIANCE_SECTION_WHITE,
  complianceSectionColoredSmall: COMPLIANCE_SECTION_COLORED_SMALL,
  complianceSectionWhiteSmall: COMPLIANCE_SECTION_WHITE_SMALL,
};
