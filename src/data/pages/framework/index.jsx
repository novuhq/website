...
const INFRASTRUCTURE_CLASS_NAME = {
  ...
  cards: [
    {
      ...
      image: (
        <StaticImage
          className={INFRASTRUCTURE_CLASS_NAME.CARDS_IMAGE_CLASS_NAME_DESKTOP}
      ...
      imageMobile: (
        <StaticImage
          className={INFRASTRUCTURE_CLASS_NAME.CARDS_IMAGE_CLASS_NAME_MOBILE}
