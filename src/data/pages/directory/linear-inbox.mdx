...
description: Linear-inspired notification system using **Novu**. It demonstrates how to integrate Novu's capabilities to deliver a seamless, multi-channel notification experience for a task management application.

authors:
  - name: Emil Pearce
    avatar: ./images/authors/emil_pearce.jpeg
images:
  - ./images/Linear-example/Linear-inbox.png
