...
await novu.trigger(
  'new-comment', {
  to: [
    { type: 'Topic', topicKey: 'issue-ENG-123' }
    ],
  payload: {
    id: 'ENG-123',
...
await novu.trigger('team-cycle-started', {
  to: [
    { type: 'Topic', topicKey: 'team-engineering' }
    ],
  payload: {
    id: 'cycle-123',
...
await novu.trigger(
  ...
  {
    to: [
      { type: "Topic", topicKey: "issue-ENG-158" } // Target Recipients
      ],
...
```json
{
  ...
  "to": [{
    "type": "Topic",
    "topicKey": "project-5d241600-202d-4e52-96e3-f8e3455f448c"
  }],
  "payload": {
